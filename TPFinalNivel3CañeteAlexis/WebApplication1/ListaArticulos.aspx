...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div id="Filtro">
        <div class="row">
            <div class="col-3">
                <div class="mb-3">
                    <asp:TextBox ID="TxtFiltro" Aria-label="Nombre" AutoPostBack="true" CssClass="form-control" OnTextChanged="TxtFiltro_TextChanged" runat="server" />
    ...
    <div id="FiltroAvanzado">
        ...
        <div class="row">
            ...
            <div class="col-3">
                <div class="mb-3">
                    <asp:TextBox runat="server" ID="TxtFiltroAvazando" CssClass="form-control" aria-label="Buscar" />
                </div>
            </div>
            <div class="col-3">
                <div class="mb-3">
